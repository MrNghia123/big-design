...
export var StyledButton = /*#__PURE__*/styled.button.withConfig({
  ...
  var icon = _ref16.iconOnly,
      theme = _ref16.theme;
  return icon && css(["padding:0 ", ";"], theme.spacing.xSmall);
}, function (_ref17) {
...
export var ContentWrapper = /*#__PURE__*/styled.span.attrs({}).withConfig({
...
export var LoadingSpinnerWrapper = /*#__PURE__*/styled(Flex).withConfig({
...
var ButtonPrimary = /*#__PURE__*/css(["background-color:", ";border-color:", ";font-weight:", ";&:active{background-color:", ";}&:focus{box-shadow:", ";}&:hover:not(:active){background-color:", ";}&[disabled]{background-color:", ";}"], function (_ref21) {
...
var ButtonPrimaryDestructive = /*#__PURE__*/css(["background-color:", ";border-color:", ";font-weight:", ";&:active{background-color:", ";}&:focus{box-shadow:", ";}&:hover:not(:active){background-color:", ";}&[disabled]{background-color:", ";}"], function (_ref28) {
...
var ButtonSecondary = /*#__PURE__*/css(["background-color:transparent;border-color:", ";color:", ";&:active{background-color:", ";}&:focus{box-shadow:", ";}&:hover:not(:active){background-color:", ";}&[disabled]{color:", ";}"], function (_ref35) {
...
var ButtonSecondaryDestructive = /*#__PURE__*/css(["background-color:transparent;border-color:", ";color:", ";&:active{background-color:", ";}&:focus{box-shadow:", ";}&:hover:not(:active){background-color:", ";}&[disabled]{color:", ";}"], function (_ref41) {
...
var ButtonSubtle = /*#__PURE__*/css(["background-color:transparent;border-color:transparent;color:", ";&:active{background-color:", ";}&:focus{box-shadow:", ";}&:hover:not(:active){background-color:", ";}&[disabled]{border-color:transparent;color:", ";}"], function (_ref47) {
...
var ButtonSubtleDestructive = /*#__PURE__*/css(["background-color:transparent;border-color:transparent;color:", ";&:active{background-color:", ";}&:focus{box-shadow:", ";}&:hover:not(:active){background-color:", ";}&[disabled]{border-color:transparent;color:", ";}"], function (_ref52) {

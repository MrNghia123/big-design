...
export var Dropdown = memo(function (_ref) {
  var className = _ref.className,
      ...
      toggle = _ref.toggle,
      style = _ref.style,
      rest = _objectWithoutProperties(_ref, ["className", "disabled", "maxHeight", "id", "items", "placement", "toggle", "style"]);
  ...
  var renderToggle = useMemo(function () {
    return /*#__PURE__*/React.createElement(Reference, null, function (_ref3) {
      var ref = _ref3.ref;
      return isValidElement(toggle) && cloneElement(toggle, _objectSpread({}, getToggleButtonProps({
        disabled: disabled,
        ref: ref
      })));
    });
  ...
  var renderGroup = useCallback(function (group) {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ListGroupHeader, null, group.label), renderItems(group.items));
  }, [renderItems]);
  ...
  return /*#__PURE__*/React.createElement(Manager, null, /*#__PURE__*/React.createElement(StyledBox, null, renderToggle, isOpen && renderList));
});
